<?php
    ...
    if($conn) {
        ...
        $query = "SELECT Id, `Date`, `Description`, Debit, Credit FROM transaction WHERE PeriodId = $periodId AND AccountId = $accountId AND Posted = $posted AND Status = 1 ORDER BY `Date` ASC;";
