...
/* harmony export */   TransactionPanel: () => (/* reexport safe */ _trans_panel__WEBPACK_IMPORTED_MODULE_2__.TransactionPanel),
...
/* harmony import */ var _trans_panel__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./trans-panel */ "./scripts/components/trans-panel.ts");
...
/***/ "./scripts/components/trans-panel.ts":
/*!*******************************************!*\
  !*** ./scripts/components/trans-panel.ts ***!
  \*******************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
let TransactionPanel = class TransactionPanel extends _sagemodeninja_custom_component__WEBPACK_IMPORTED_MODULE_0__.CustomComponent {
    render() {
        return `
...
__decorate([
    (0,_sagemodeninja_custom_component__WEBPACK_IMPORTED_MODULE_0__.queryAll)('.action-button'),
    __metadata("design:type", Array)
], TransactionPanel.prototype, "_actionBtns", void 0);
TransactionPanel = __decorate([
    (0,_sagemodeninja_custom_component__WEBPACK_IMPORTED_MODULE_0__.customComponent)('transaction-panel')
], TransactionPanel);
...
/* harmony import */ var _services__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @/services */ "./scripts/services/index.ts");
/* harmony import */ var _classes_forms__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @/classes/forms */ "./scripts/classes/forms/index.ts");
...
class DashboardView {
    ...
    constructor() {
        this._walletService = new _services__WEBPACK_IMPORTED_MODULE_1__.WalletService();
        this._ledgerService = new _services__WEBPACK_IMPORTED_MODULE_1__.LedgerService();
        this._body = document.querySelector('#wallet_body');
        this._transactionPnl = document.querySelector('#transaction_panel');
        this._form = new _classes_forms__WEBPACK_IMPORTED_MODULE_2__.LedgerForm('#ledger_form');
