...
/* harmony import */ var _services_user_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @/services/user-service */ "./scripts/services/user-service.ts");
...
class UserView {
    constructor() {
        ...
        this._service = new _services_user_service__WEBPACK_IMPORTED_MODULE_2__.UserService();
