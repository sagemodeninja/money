...
<body>
                ...
                <div id="layout_workspace">
                    <div id="account_balances_root_container">
                        <div style="display: flex; align-items: center;">
                            <h2 style="margin: 0;"><?php echo $accountTitle; ?></h2>
                    ...
                    <div id="transaction_tab_root_container">
                        <fluent-tabs activeid="actual" id="transaction_tab">
                            ...
                            <fluent-tab-panel>
                                <!--ACTUAL -->
                                <div class="transaction_tab active" data-tab="actual">
                        ...
                        <!--<div id="transaction_tab_btn_container">-->
                        <!--    <a class="tab_btn active" data-tab="actual">-->
                        <!--        <span>Actual</span>-->
                        <!--        <span class="tab-btn-base"></span>-->
                        <!--    </a>-->
                        <!--    <a class="tab_btn" data-tab="projection">-->
                        <!--        <span>Projection</span>-->
                        <!--        <span class="tab-btn-base"></span>-->
                        <!--    </a>-->
                        <!--</div>-->
                        <!--<div id="transaction_tab_container">-->
                             <!--ACTUAL -->
                        <!--    <div class="transaction_tab active" data-tab="actual">-->
                        <!--        <p class="centered">Press "Refresh" to retrieve list.</p>-->
                        <!--    </div>-->
    ...
    <div class="layout-space modal-space">
        <div id="editor_container" class="layout-modal">
            <div class="modal-container" style="height: 60%; width: 90%;">
                <div class="modal-head">
                    <h3>Transaction</h3>
                    <button class="modal-action modal-close-button material-icons" data-role="close">close</button>
                </div>
