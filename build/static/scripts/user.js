...
class UserView {
    constructor() {
        ...
        this._service = new _services__WEBPACK_IMPORTED_MODULE_3__.UserService();
        this.addEventListeners();
    }
    async refresh() {
